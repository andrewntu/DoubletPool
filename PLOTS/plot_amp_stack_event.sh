...
if [ ! -d "Fig_amp_stack" ];then
	mkdir Fig_amp_stack/
fi
if [ ! -d "Fig_amp_stack/${csta}" ];then
	mkdir Fig_amp_stack/${csta}
fi
if [ ! -d "Fig_amp_stack/${csta}/${freq}hz" ];then
	mkdir Fig_amp_stack/${csta}/${freq}hz
fi
ofold=Fig_amp_stack/${csta}/${freq}hz
