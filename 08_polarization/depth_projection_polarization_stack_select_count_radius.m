...
dist_cri = 35; % in meter, compared to Old Faithful Cone
...
for s = 1:length(stage_all)
	...
	pfile = strcat('../../Polarization_out_stack_select_count/',sta,'_polarization_all_4project_stage.',stage,'_select.txt')
...
dd = dist(ide);
	...
	outdir= strcat('../../Projection_stack_select_count/');
	...
	outdirmat= strcat('../../Projection_mat_stack_select_count/');
