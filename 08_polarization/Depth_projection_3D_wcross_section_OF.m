...
pfile = strcat('../../Polarization_out/polarization_4projection_stage.',stage,'_select.txt');
% pfile = strcat('../../Polarization_out_select50/',sta,'_polarization_all_4project_stage.',stage,'_select.txt')
...
h.MarkerFaceColor = [0.9 0 0];
pic1 = strcat('../../Projection_fig/Polarization_stage.',stage,'.png');
pic1s = strcat('../../Projection_fig/Polarization_stage.',stage,'.fig');
saveas(figure(1),pic1);
savefig(figure(1),pic1s,'compact');

% save the hit count matrix
mat = strcat('../../Projection_mat/polarization_project_total_stage.',stage,'.mat')
save(mat,'total')
