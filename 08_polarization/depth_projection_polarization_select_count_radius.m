...
%     for s = 1:1
		...
		pfile = strcat('../../Polarization_out_single_select_count/eruption_',ee,'/',sta,'_polarization_all_4project_stage.',stage,'_select.txt')
		...
		outdir= strcat('../../Projection_single_select_count/');
		if not(isfolder(outdir))
		mkdir(outdir)
		end

		outdir= strcat('../../Projection_single_select_count/eruption_',ee);
		if not(isfolder(outdir))
		mkdir(outdir)
		end
		...
		outdirmat= strcat('../../Projection_mat_single_select_count/eruption_',ee);
