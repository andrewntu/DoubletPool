...
h.MarkerFaceColor = [0.9 0 0];
pic1 = strcat('../../Projection_fig_select/Polarization_stage.',stage,'.png');
pic1s = strcat('../../Projection_fig_select/Polarization_stage.',stage,'.fig');
saveas(figure(1),pic1);
savefig(figure(1),pic1s,'compact');

% save the hit count matrix
mat = strcat('../../Projection_mat_select/polarization_project_total_stage.',stage,'.mat')
save(mat,'total')
