...
ofile = strcat('../../Polarization_out_select50/',sta,'_polarization_all_4project_stage.',stage,'_select.txt')
...
[stap3, stlo3, stla3, possnr, negsnr, avgsnr] = textread(phfile,'%s %f %f %f %f %f\n','headerlines',0);
