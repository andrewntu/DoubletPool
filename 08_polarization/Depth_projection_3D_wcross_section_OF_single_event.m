...
pfile = strcat('../../Polarization_out_single/eruption_',ee,'/',sta,'_polarization_all_4project_stage.',stage,'.txt')
...
outdir= strcat('../../Projection_single/eruption_',ee);
...
outdirmat= strcat('../../Projection_mat_single/eruption_',ee);
...
mat2 = '../../Projection_mat_single/cross-Z.mat';
save(mat2,'crossall')


% save the station location in mat
sta = [y,x,-z];
mat3 = strcat('../../Projection_mat_single/staloc_select.mat');
save(mat3,'sta')
