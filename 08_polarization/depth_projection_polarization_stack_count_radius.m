...
for s = 1:length(stage_all)
	...
	pfile = strcat('../../Polarization_out_stack_count/',sta,'_polarization_all_4project_stage.',stage,'_select.txt')
...
dd = dist(ide);
	...
	outdir= strcat('../../Projection_stack_count/');
	...
	outdirmat= strcat('../../Projection_mat_stack_count/');
