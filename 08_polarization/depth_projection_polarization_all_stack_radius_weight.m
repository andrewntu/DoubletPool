...
for s = 1:length(stage_all)
	...
	pfile = strcat('../../Polarization_out_stack_all/',sta,'_polarization_all_4project_stage.',stage,'_select.txt')
	...
	outdir= strcat('../../Projection_stack_all/');
	...
	outdirmat= strcat('../../Projection_mat_stack_all/');
